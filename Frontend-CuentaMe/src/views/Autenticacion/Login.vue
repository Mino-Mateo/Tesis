...
<template>
  ...
  <main id="main" class="flex flex-col w-full min-h-screen">
    <div class="flex flex-1 items-center justify-center">
      <div class="w-full max-w-sm p-10 bg-primary rounded-[30px] shadow-lg h-auto sm:h-[400px]">
        <!-- Texto de Bienvenida -->
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div class="relative">
            ...
            <input type="email" id="email" v-model="email" required
              class="block w-full pl-12 pr-3 py-3 text-center text-neutral font-bold bg-light border border-gray-300 rounded-input shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary focus:border-primary"
          ...
          <div class="relative">
            ...
            <input :type="showPassword ? 'text' : 'password'" id="clave" v-model="clave" required
              class="block w-full pl-12 pr-12 py-3 text-center text-neutral font-bold bg-light border border-gray-300 rounded-input shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary focus:border-primary"
          ...
          <!-- Ingreso -->
          <div class="relative">
            <router-link to="/Menu"> <button type="submit"
